...
--
-- Host: localhost:8889
-- Generation Time: Nov 24, 2014 at 04:01 PM
...
INSERT INTO `articles` (`id_article`, `titre`, `contenu`, `date`, `note`, `id_user`) VALUES
...
INSERT INTO `utilisateurs` (`id_user`, `nom_user`, `email`, `password`, `id_profil`) VALUES
(1, 'Loode', 'louisdebraine@gmail.com', '*94BDCEBE19083CE2A1F959FD02F964C7AF4CFC29', 1),
(2, 'Toto', 'toto@toto.com', '*63D85DCA15EAFFC58C908FD2FAE50CCBC60C4EA2', 1),
(3, 'Test', 'test@test.com', '*94BDCEBE19083CE2A1F959FD02F964C7AF4CFC29', 0);
