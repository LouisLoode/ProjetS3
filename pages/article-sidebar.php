				...
				<div class="col-md-8 bg-base col-lg-8 col-xl-9">
					...
					<article class="entry style-single type-post">
						...
						<div class="entry-content indented">
							...
							<div class="bg-page flushed-left ad-wrapper">
						
								<div class="ad-inner">
									<div class="ad ad-410x125">
										<a href="https://wrapbootstrap.com/e" rel="nofollow"><img src="http://placehold.it/410x125&amp;text=410x125%20banner" alt=""></a>
									</div>
								</div>
					...
					<div class="after-entry indented">
						...
						<aside class="widget ad-wrapper row">


							<div class="ad-inner col-sm-6">
...
<?php
include('sidebar/sidebar-articles.php');
?>
			</div><!--/#content-->
